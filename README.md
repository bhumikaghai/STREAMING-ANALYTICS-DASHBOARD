...
This project focuses on performing **Exploratory Data Analysis (EDA)** on Netflix Movies and TV Shows data using Python. The analysis was carried out to better understand streaming content trends, audience preferences, release patterns, and platform growth over time.
...
![Ratings Distribution](images/content_ratings_distribution.png)
...
This project successfully demonstrated how data analysis can be used to extract meaningful insights from streaming platform data. By performing data cleaning, visualization, and exploratory analysis, the project identified important trends related to content distribution, release patterns, and audience ratings.
